...
await check('Campaign data request','/assets/templates/closed-beta/VIIMsignal_Campaign_Data_Request.csv',({text})=>text.startsWith('campaign_id,campaign_name,start_at,end_at,channel_code,campaign_type,budget,spend,impressions,clicks,conversions,attributed_sales'));
