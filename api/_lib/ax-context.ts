...
function metricLabel(value:string){return ({net_sales:'순매출',quantity:'판매수량',orders:'주문수',available_qty:'가용재고',inventory_cover_days:'재고커버',contribution_margin:'기여이익',return_rate:'반품률',sell_through_rate:'판매율',exposure_score:'노출도',best_rank:'순위',avg_rating:'평점',total_review_count:'리뷰 수',marketing:'캠페인 성과'} as Record<string,string>)[value]||value}
function dimensionLabel(value:string){return ({day:'일',channel:'채널',location:'매장·지역',product:'제품',brand:'브랜드',platform:'플랫폼',category:'카테고리',market_product:'외부상품',campaign:'캠페인'} as Record<string,string>)[value]||value}
