const ENTITY_FIELDS:Record<string,string[]>={
  ...
  marketing_campaign:['campaign_id','campaign_name','start_at','end_at','channel_code','campaign_type','budget','spend','impressions','clicks','conversions','attributed_sales','control_group_size','control_group_conversions','owner','status','source_updated_at']
};
...
const REQUIRED_FIELDS:Record<string,string[]>={
  ...
  marketing_campaign:['campaign_id','campaign_name','start_at','end_at','channel_code','budget','spend','impressions','clicks','conversions','attributed_sales','source_updated_at']
};
