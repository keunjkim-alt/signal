...
const pageAliases:any={'오늘 결정할 일':'action','판매 현황':'hub','판매 허브':'hub','목표·마감 예측':'targets','전사 목표·마감예측':'targets','수익성·할인':'profitability','수익성·할인 분석':'profitability','지금 주목할 신호':'anomalies','판매 이상 감지':'anomalies','상품 수요·생애주기':'sales','제품 판매·생애주기':'sales','고객·지역':'customers','고객·지역 분석':'customers','반품·취소':'returns','반품·취소 분석':'returns','주요 의사결정':'decisions','경영 의사결정':'decisions','상품기획':'planning','디자인':'design','생산':'production','재고 운영':'inventory','마케팅':'marketing','마켓레이더':'market','디자이너 360':'designer','데이터 연결':'connections','데이터 연결 관리':'connections','사용자·권한':'permissions','사용자·권한 관리':'permissions'};
