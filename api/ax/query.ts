...
export default {async fetch(request:Request){
  ...
  try{const context=await requestContext(request);const body=await bodyJson(request),page=String(body?.page||'hub'),org=context.membership.organization_id,contextReady=performance.now();
